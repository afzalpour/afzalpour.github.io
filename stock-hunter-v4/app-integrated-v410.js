...
printDetail = function(){
  ...
  const models=forecastModels(x),ft=forecastTable(models),w=window.open('','_blank','width=1100,height=1100');if(!w)return;
  const reasons=decisionReasonsV410(x);
  const metrics=[
