...
const ERROR_MESSAGES_FA = Object.freeze({
  ...
  TAX_SETTINGS_ROLE_NOT_ALLOWED: 'فقط مالک یا مدیر شرکت می‌تواند تنظیمات مالیاتی را تغییر دهد.',
  TAXPAYER_TYPE_INVALID: 'نوع مودی مالیاتی معتبر نیست.',
  ACTIVE_TAX_RULE_REQUIRED: 'برای فعال‌سازی مالیات، باید قاعده مالیاتی فعال و معتبر وجود داشته باشد.',
  TAX_PROFILE_REQUIRED: 'برای هر ردیف فاکتور، وضعیت مالیاتی را انتخاب کنید.',
  TAX_PROFILE_INVALID: 'پروفایل مالیاتی انتخاب‌شده معتبر یا فعال نیست.',
  TAX_PROFILE_NOT_APPLICABLE: 'پروفایل مالیاتی انتخاب‌شده برای این نوع فاکتور قابل استفاده نیست.',
  TAX_RULE_NOT_EFFECTIVE: 'قاعده مالیاتی انتخاب‌شده در تاریخ این فاکتور معتبر نیست.',
  TAX_STANDARD_RATE_MISMATCH: 'نرخ پروفایل استاندارد با نرخ معتبر دوره مالیاتی سازگار نیست.',
  TAX_RULE_REQUIRED: 'پروفایل نرخ استاندارد باید به یک قاعده مالیاتی معتبر متصل باشد.',
  TAX_SNAPSHOT_REQUIRED: 'اطلاعات مالیاتی ردیف‌های فاکتور کامل نیست؛ فاکتور را دوباره ذخیره کنید.',
  VAT_ACCOUNT_ROLE_MISSING: 'حساب معین مالیات بر ارزش افزوده برای این شرکت آماده نیست.',
