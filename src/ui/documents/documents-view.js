  ...
  return `
    <div class="section-head">
      ...
      <div>
        ...
        <span class="muted">
          عکس یا PDF را ثبت کنید؛
          OCR و پیشنهاد حسابداری در مرحله بعد
          روی همین سند انجام می‌شود.
        </span>
      </div>
...
documentUploadModalHtml({
  ...
  return `
    ...
    <div class="info-box">
      ...
      فایل در Storage خصوصی آوان نگهداری می‌شود.
    </div>
