...
const EXACT = new Map([
  ...
  ['inventory_reversal', 'برگشت انبار'],
  ['check_issue', 'صدور چک'],
...
const REPLACERS = [
  ...
  [/accountant/gi, 'حسابدار'], [/manager/gi, 'مدیر'], [/owner/gi, 'مالک']
];

export function translateUserFacingText(value) {
...
export function safeUserFacingFa(value, fallback = 'رویداد سامانه') {
