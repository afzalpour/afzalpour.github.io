...
const REPLACERS = [
  ...
  [/Pending workspace invitation for .* as manager/gi, 'دعوت کاربر برای نقش مدیر در انتظار پذیرش است'],
  [/Workspace member added as accountant/gi, 'کاربر با نقش حسابدار به شرکت افزوده شد'],
  [/Platform Admin/gi, 'مدیر سامانه'],
  [/SaaS Control Plane/gi, 'مرکز مدیریت سامانه'],
  [/Control Plane/gi, 'مرکز مدیریت سامانه'],
  [/Support Session/gi, 'دسترسی پشتیبانی'],
  [/Support/gi, 'پشتیبانی'],
  [/Session/gi, 'نشست'],
  [/Read-only/gi, 'فقط‌خواندنی'],
  [/Read only/gi, 'فقط‌خواندنی'],
  [/Viewer/gi, 'نمایشگر'],
  [/Tenant/gi, 'شرکت'],
  [/Workspace/gi, 'شرکت'],
  [/Onboarding/gi, 'راه‌اندازی'],
  [/Registry/gi, 'ثبت سامانه'],
  [/Ledger/gi, 'دفتر حسابداری'],
  [/Posted\/Reversed/gi, 'ثبت‌قطعی/برگشتی'],
  [/Posted/gi, 'ثبت‌قطعی'],
  [/Reversed/gi, 'برگشتی'],
  [/Posting/gi, 'ثبت قطعی'],
  [/Immutable/gi, 'غیرقابل‌تغییر'],
  [/Database/gi, 'پایگاه داده'],
  [/LocalStorage/gi, 'حافظه محلی مرورگر'],
  [/Dashboard/gi, 'داشبورد'],
  [/Supabase/gi, 'زیرساخت ابری'],
  [/Core/gi, 'هسته'],
  [/Enterprise/gi, 'سازمانی'],
  [/Pro/gi, 'حرفه‌ای']
];
