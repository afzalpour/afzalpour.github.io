...
Status: **PREPARATION STARTED — Production promotion NOT authorized**

Date: **2026-09-10**

This checklist starts the governed step after RC1.6 feature completion. It does not release or copy Staging runtime to Production.

## Current release boundary

- Production root remains **RC1.5**.
- RC1.6 work remains under `avan-staging/`.
- Current Staging functional merge head: `781ce0418c86a492a656080ac45681b6251804cb`.
...
- [ ] **PR #113 final presentation Live Gate** — BLOCKING before RC1.6 promotion preparation can be marked complete.

## PR #113 Live checks

- [ ] Reports launcher shows only Party selector + `مشاهده صورتحساب`.
- [ ] Statement keeps Jalali from/to controls and no redundant Jalali instruction.
- [ ] Party Ledger detail headings and values are centered on screen.
- [ ] Party Ledger detail headings and values are centered in Print/PDF.
- [ ] Negative financial outputs display visually as red `(amount)` with no visible minus.
- [ ] Signed numeric truth/calculations remain unchanged.

## Release Gate prerequisites after final Live PASS
...
**No automatic promotion.** RC1.6 may reach Production only after the final Live gate and a separate explicit Production Release Gate. Database rollback must never be destructive; frontend rollback and additive database compatibility rules remain in force.
